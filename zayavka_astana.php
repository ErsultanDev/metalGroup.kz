...
<meta name="keywords" content="Письмо руководству">
<meta name="description" content="Написать письмо руководству MetalGroup">
...
<div class="chernyi"> <p><span style="color:#ffc843; font-weight:600">Звоните нам: </span><a href="tel:87273449900">Алматы 8(727) <b>344 99 00</b></a></p> <p> <a href="tel:87172279900">Нур-Султан 8(7172) <b>27 99 00</b></a></p></div></div>
			...
			<div class="menu_lists"><ul class="menu">
				<li class="selected"><a href="index.html"><span>Главная</span></a></li>
					<li class="tovary_menu"><a href="products.html"><span>Товары</span></a></li><li class="news_menu"><a href="news.html"><span>Новости</span></a></li>
					<li class="design_menu"><a href="des.html"><span>3D Дизайн</span></a></li>
				<li class="dostavka_menu"><a href="services.html"><span>Доставка</span></a></li><li class="otzyvy_menu"><a href="otzovik.php"><span>Отзывы</span></a></li>
		...
		<div class="section">
				...
				<ul class="tochki">
					<li><p><a href="stellazhtor.html"><img src="/images/bullets.png"> Торговые стеллажи</a></p><hr></li>		
					
					<li>
						<p><a href="sklad.html"><img src="/images/bullets.png"> Складские стеллажи </a><hr></p>
						
					</li>	
					<li><p><a href="pallet.html"><img src="/images/bullets.png"> Паллетные стеллажи </a></p><hr></li><li><p><a href="vitrina.html"><img src="/images/bullets.png"> Витрины</a></p><hr></li><li><p><a  href="mebel_butik.html"><img src="/images/bullets.png"> Мебель для бутика и аптеки</a></p><hr></li>	
					 						
					<li><p><a href="mebel_butik.html"><img src="/images/bullets.png"> Мебель для бутика и аптеки</a></p><hr></li>
					<li><p><a href="obor.html"><img src="/images/bullets.png"> Торговое оборудование </a></p><hr></li>
					<li><p><a href="holod.html"><img src="/images/bullets.png"> Холодильное оборудование</a></p><hr></li>
					<li><p><a href="neutral.html"><img src="/images/bullets.png"> Нейтральное оборудование</a></p><hr></li>
					<li><p><a href="pos_obor.html"><img src="/images/bullets.png"> POS оборудование </a></p><hr></li><li><p><a href="kassovyie_boksyi.html"><img src="/images/bullets.png"> Кассовые боксы </a></p><hr></li>			
					
					 					
					<li><p><a href="met_shkaf.html"><img src="/images/bullets.png"> Металлические шкафы</a></p><hr></li>	
					 		
					<li><p><a href="horest.html"><img src="/images/bullets.png"> Профессиональное кухонное оборудование </a></p></li>													
				</ul>
				<br>
				</div><div><a href="contact.html">	<p class="catalog_contact">Контакты</p><ul class="tochki">
...
<li>
					...
					<li>
						<p><b>Email: </b>astana@idiamarket.kz</p></li></ul></a></div>
			</div>
			<div class="featured">
			<div class="napravo">
			<div class="main">
				<div class="caption_p"><strong>Письмо в отдел продаж</strong></div>
				  <p><b>Если Вы хотите оставить заявку, заполните эту форму.</b></p>
				
 <br><p>Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
 <br><p>Или пишите на почту:  <b>zakaz@idiamarket.kz</b></p>
 <br>
<form id="my_form_email" style="margin-top:1em;">
	<div class="mar10-tb" style="float:none"><label style="font-weight:500; float:none">Ваше имя (наименование организации):</label></div><input type="text" class="textbox-pismo" name="f[name]" required>
	<div class="mar10-tb" style="float:none"><label style="font-weight:500">Ваш e-mail: </label></div><input type="email" name="f[email]" class="textbox-pismo" required>
	<div class="mar10-tb" style="float:none"><label style="font-weight:500">Номер телефона:</label></div> <input type="text" name="f[phone]"  id="phone" class="textbox-pismo">
	<div class="mar10-tb" style="float:none"><label style="font-weight:500">Ваше сообщение:</label></div> <textarea type="text" class="textbox1" style="float:none;" name="f[mes]" required></textarea>
	<div style="margin-top:10px; float:none"><button type="submit" class="vpb_general_button" >Отправить</button></div>
</form> 
...
<div id="my_message_email"></div>
  ...
  <dl>
   <dd><a href="contact.html"><b>Телефон:</b><br>  8 (727) 344-99-00 <br> +7 (701) 266-77-00 ⁣</a></dd><br>		
  </dl>
  <dl>
