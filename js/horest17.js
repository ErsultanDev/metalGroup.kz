const data = [                    // _____________________________________Миксеры, блендеры____________________________________________
...
const labels = document.getElementById('horest17Js');
