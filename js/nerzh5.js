const data = [     // _____________________________________Тележки для транспортировки____________________________________________
    {
        link: "shpilka.html",
...
const labels = document.getElementById('nerzh5Js');
