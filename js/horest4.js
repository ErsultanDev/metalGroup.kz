const data = [ // _____________________________________Сковороды электрические____________________________________________
    {
...
const labels = document.getElementById('horest4Js');
