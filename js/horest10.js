const data = [ // _____________________________________Линии раздачи Мастер____________________________________________
    {
...
const labels = document.getElementById('horest10Js');
