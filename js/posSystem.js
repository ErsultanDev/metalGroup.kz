const data = [{
    link: "pos376.html",
    title: "POS-система 376",
    desc: "POS-система 376 предназначена для автоматизации супермаркетов, магазинов и других типов торговли. Она отличается тем что, имеет все необходимые оборудования для кассы: монитор, принтер чеков, денежный ящик, а также дисплей покупателя.",
    img: "/images/fulls/monitor/8.jpg",
    price: 93981,
    code: 1901
}, {
    link: "pos_td_35.html",
    ...
    img: "/images/fulls/monitor/20.jpg",
    price: 140300,
    code: 1902
}]

const labels = document.getElementById('pos_systems');
