const data = [{
    link: "till410.html",
    title: "Денежный ящик 410B",
    desc: "Денежный ящик ящик со съемными 7 отделениями для купюр с прижимными лапками, 4 для монет предназначен для надежного хранения денег, чеков и остальной документации. Ящик идет с уникальным замком и с функцией блокировки.",
    img: "/images/fulls/till/1.jpg",
    price: 19550,
    code: 1941
}, {
    link: "till405.html",
    title: "Денежный ящик 405A",
    desc: "Денежный ящик металлический со съемными 5 отделениями для купюр с прижимными лапками, 8 для монет предназначен для надежного хранения денег, чеков и остальной документации. Ящик идет с уникальным замком и с функцией блокировки.",
    img: "/images/fulls/till/2.jpg",
    price: 21250,
    code: 1942
}, {
    link: "till170.html",
    ...
    img: "/images/thumbs/till/1701.png",
    price: 32625,
    code: 5305
}, ]

const labels = document.getElementById('tillOv');
