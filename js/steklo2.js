const data = [ // _____________________________________Стеклянные витрины____________________________________________
    {
...
const labels = document.getElementById('stekloJs');
