const data = [       // _____________________________________Неохлаждаемые Прилавки____________________________________________
    {
...
const labels = document.getElementById('nerzh8Js');
