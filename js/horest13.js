const data = [ // _____________________________________Гастроемкости из нержавейки____________________________________________
    {
...
const labels = document.getElementById('horest13Js');
