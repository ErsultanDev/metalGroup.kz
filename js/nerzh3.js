const data = [ // _____________________________________Мойки____________________________________________
    {
...
const labels = document.getElementById('nerzh3Js');
