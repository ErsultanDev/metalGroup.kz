const data = [ // _____________________________________Жарочные шкафы____________________________________________
...
const labels = document.getElementById('horest3Js');
