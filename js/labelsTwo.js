const data = [{
        ...
        img: "/images/thumbs/scanner/universal1.jpg",
        price: 2355,
        code: 2009
    },
]

const labels = document.getElementById('labelsTwo');

const monoblocksBlock = document.getElementById('prodItems4');const priceSort = document.getElementById("priceSort");
