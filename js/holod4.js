const data44 = [ // ________________________________Холодильные шкафы с глухими дверьми_____________________________________________________
    {
        link: "cm105s.html",
...
const span4 = document.querySelectorAll('#ggg')
    ...
    span4.forEach(function(t) {
        ...
        if (span4_p != null) {
            ...
            if (t_href_main != null) {
                ...
                data44.forEach(function(z) {
                    if (t_href == z.link) {
                        item.innerHTML = `
                <p><span class="item-price-indicator_second">Цена: ${formatter(z.price)}</span></p>`
                    }
                })
            }
        }
...
// ___________
const span5_price_main = document.querySelector('.price')
...
data44.forEach(function(z) {
    if (span5_price_main != null) {
        if (span5_price_main != null) {
            ...
            if (url_name == z.link) {
                span5_price_main.innerHTML = `от ${formatter(z.price)} ₸`
            }
        }
    }
})
...
const labels = document.getElementById('holod4');
const priceSort = document.getElementById('priceSort');

let priceSortedArray = data44.sort(function(a, b) {
    let x = a.price;
    let y = b.price;
...
if (priceSort != null) {
    ...
    priceSort.addEventListener("change", function() {
        if (priceSort.value == "first") {
            priceSortedArray = data44.sort(function(a, b) {
                let x = a.price;
                let y = b.price;
