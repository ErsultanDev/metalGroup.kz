const data = [ // _____________________________________Жарочные поверхности____________________________________________
...
const labels = document.getElementById('horest2Js');
