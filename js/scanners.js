...
const monoblocksBlock = document.getElementById('prodItems3');const priceSort = document.getElementById("priceSort");
...
// function modeBtn1Click() {
//     if (modeBtn1.checked == true) {
//         filterOptionArray.push('ручной')
//         clickArr.push(modeBtn1)
//         arrCounter = true;
//     } else {
//         spliceMethod(modeBtn1);
//         spliceMethodSecond('ручной')
//         arrCounter = false;
//     }
//     updateFilterParam()
// }

// function modeBtn2Click() {
//     if (modeBtn2.checked == true) {
//         filterOptionArray.push('непрерывный')
//         clickArr.push(modeBtn2)
//         arrCounter = true;
//     } else {
//         spliceMethod(modeBtn2);
//         spliceMethodSecond('непрерывный')
//         arrCounter = false;
//     }
//     updateFilterParam()
// }

// function modeBtn3Click() {
//     if (modeBtn3.checked == true) {
//         filterOptionArray.push('постоянный')
//         clickArr.push(modeBtn3)
//         arrCounter = true;
//     } else {
//         spliceMethod(modeBtn3);
//         spliceMethodSecond('постоянный')
//         arrCounter = false;
//     }
//     updateFilterParam()
// }

// function modeBtn4Click() {
//     if (modeBtn4.checked == true) {
//         filterOptionArray.push('индукционный')
//         clickArr.push(modeBtn4)
//         arrCounter = true;
//     } else {
//         spliceMethod(modeBtn4);
//         spliceMethodSecond('индукционный')
//         arrCounter = false;
//     }
//     updateFilterParam()
// }

// function modeBtn5Click() {
//     if (modeBtn5.checked == true) {
//         filterOptionArray.push('мигающий')
//         clickArr.push(modeBtn5)
//         arrCounter = true;
//     } else {
//         spliceMethod(modeBtn5);
//         spliceMethodSecond('мигающий')
//         arrCounter = false;
//     }
//     updateFilterParam()
// }
...
function countParam(array) {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        // for (let i = 0; i < array[index].scanMode.length; i++) {
        //     if (array[index].scanMode[i] == "first") {
        //         scanMode1++;
        //     } else if (array[index].scanMode[i] == "second") {
        //         scanMode2++;
        //     } else if (array[index].scanMode[i] == "third") {
        //         scanMode3++;
        //     } else if (array[index].scanMode[i] == "fourth") {
        //         scanMode4++;
        //     } else if (array[index].scanMode[i] == "fifth") {
        //         scanMode5++;
        //     }
        // }
    }
