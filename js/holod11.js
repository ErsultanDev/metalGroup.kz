const data = [ // ______________________________________Морозильные лари_______________________________________________
    {
...
const labels = document.getElementById('holod11');
