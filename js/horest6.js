const data = [ // _____________________________________Печи для пиццы____________________________________________
    {
...
const labels = document.getElementById('horest6Js');
