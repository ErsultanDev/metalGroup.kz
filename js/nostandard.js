const data = [ // _____________________________________Нестандартные витрины и прилавки____________________________________________
    {
...
const labels = document.getElementById('nostandardJs');
