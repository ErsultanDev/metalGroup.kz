const data = [ // _____________________________________Формы из нержавейки____________________________________________
    {
...
const labels = document.getElementById('horest15Js');
