const data = [{
    ...
    {
        link: "scale_mk_a_led32.html",
        title: "Весы настольные электронные МК- 32.2-А20 LED",
        desc: "Позволяют работать в счетном режиме, режимах процентного взвешивания и контроля массы (компараторный режим).",
        price: "39550",
        img: "/images/fulls/scale/3.jpg",
        position: ["table"],
        weight: 32,
    ...
    },
    {
        ...
        link: "scale_ab_ruew.html",
        title: "Весы электронные влагозащищенные MK_AB21(RUEW)",
...
const labels = document.getElementById('scales');
