const data = [ // _____________________________________Линии раздачи Школьник____________________________________________
    {
...
const labels = document.getElementById('horest11Js');
