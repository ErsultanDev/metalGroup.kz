const data = [ // _____________________________________Торговые манежи____________________________________________
    {
        link: "manezhcel1.html",
...
const labels = document.getElementById('manezhJs');
