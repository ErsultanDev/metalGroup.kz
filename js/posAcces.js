...
const labels = document.getElementById('posAccess');
const monoblocksBlock = document.getElementById('prodItems2');const priceSort = document.getElementById("priceSort");
