const data = [ // _____________________________________Вентиляционные зонты____________________________________________
...
const labels = document.getElementById('nerzh6Js');
