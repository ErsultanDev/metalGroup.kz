const data = [
    {
        link: "scanpal_50.html",
        title: "Терминал Сбора Данных Honeywell ScanPal EDA50",
        ...
        img: "/images/fulls/terminal/1.png",
        price: 230830,
        code: 1991
    },
    {
        link: "scanpal_50_k.html",
        title: "Терминал Сбора Данных Honeywell ScanPal EDA51",
        desc: "EDA50K представляет собой гибридное устройство с операционной системой Android, предназначенное для решения широкого круга задач. Устройство оснащено сенсорным экраном с диагональю 10,2 см (4») и цифровой клавиатурой для эффективного ввода данных, поэтому его удобно использовать при работе на выезде.",
        img: "/images/fulls/terminal/terminalNew1.png",
        price: 258980,
        code: 1992
    }
];
