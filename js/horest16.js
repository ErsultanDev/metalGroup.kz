const data = [ // _____________________________________Пароконвектоматы____________________________________________
    {
        link: "steamer_6.html",
...
const labels = document.getElementById('horest16Js');
