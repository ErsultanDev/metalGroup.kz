...
<body>
    ...
    <div id="body">
        ...
        <div class="footer">
            ...
            <div class="featured featuredNone">
                <div class="napravo">
                    <div class="main">
                        <div class="caption_p"><strong>Письмо руководству</strong></div>
                        <p><b>
                                Если Вы хотите отправить письмо руководству с предложениями, замечаниями или по вопросам сотрудничества заполните эту форму.</b></p>

                        <br>
                        <p>Ваши сообщения напрямую проходят руководству. Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
                        <br>
                        <p>Или пишите на почту: <b>admin@idiamarket.kz</b></p>
                        <br>
        ...
        <div id="sidebar">
            <div class="side">
                ...
                <dl>
                    ...
                    <dd><a href="otzovik.php">Отзывы</b></a></dd>
                </dl>
                <dl>
                ...
                <dl>
                    <dd><a href="contact.html"><b>Адрес:</b><br>ул. Мынбаева 43 <br>(уг.ул. Манаса), 1-этаж, <br> Казахстан, Алматы, 050008</a></dd>
                </dl>
    ...
    <script>
        $('#my_form_email').submit(function() {
            ...
            $.post(
                'post-email_admin.php', // адрес обработчика
