...
<body>
            ...
            <div class="featured featuredNone">
                <div class="napravo">
                    <div class="main">
                        ...
                        <br>
                        <p>Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
                        <br>
                        <p>Или пишите на почту: <b>shymkent@idiamarket.kz</b></p>
                        <br>
    ...
    <script>
        $('#my_form_email').submit(function() {
            ...
            $.post(
                'post-email_shymkent.php', // адрес обработчика
